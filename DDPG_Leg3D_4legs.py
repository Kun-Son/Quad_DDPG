...
def main(_):
    with tf.Session() as sess:
        ...
        actor2 = ActorNetwork4(sess, state_dim, action_dim, action_bound,
                             ACTOR_LEARNING_RATE, TAU)

        critic2 = CriticNetwork4(sess, state_dim, action_dim, action_bound,
        ...
        saver.save(sess,'./results/{}/data0502'.format(ENV_NAME))
