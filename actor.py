...
class ActorNetwork(object):
    ...
    def create_actor_network(self):
        ...
        self.net1 = tflearn.fully_connected(inputs, 400, activation='relu')
        ...
        outputs = tflearn.fully_connected(self.net2, self.action_dim, activation='tanh', weights_init=weight_init)
